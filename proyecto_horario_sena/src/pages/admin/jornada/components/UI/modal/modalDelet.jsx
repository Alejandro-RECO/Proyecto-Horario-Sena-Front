...
import { eliminarJornada } from '../../../data/sendRequest';
      ...
      >
        <DialogContent>
          ...
          <h5 className='mt-3 font-semibold text-lg uppercase pb-2'>Esta usted seguro ?</h5>
            <p className='px-2 text-gray-400'>
             ¿Está seguro de eliminar la Jornada? Con esta acción se desactivarán los datos del mismo y toda su información relacionada.  
            </p>
          </DialogContentText>
        </DialogContent>
        <Divider/>
        <DialogActions>
          ...
          <button 
            ...
            onClick={handleDelet}>Eliminar</button>
        </DialogActions>
      </Dialog>
    </React.Fragment>
  );
